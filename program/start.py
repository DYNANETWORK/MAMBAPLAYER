...
async def start_(client: Client, message: Message):
    await message.reply_sticker("https://te.legra.ph/file/a8a793a8716bdcc923fd3.jpg")
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("ᴄʀᴇᴀᴛᴏʀ", url=f"https://t.me/BLACKMAMBA_OFFICIAL"),
                ],
                [
                    InlineKeyboardButton(
                        "ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/MAMBA_X_SUPPORT"
                    ),
                    InlineKeyboardButton(
                        "ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/MAMBA_X_SUPPORT"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url=f"https://t.me/MAMBA_X_SUPPORT"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/MAMBA_X_SUPPORT"),
                InlineKeyboardButton(
                    "ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/MAMBA_X_SUPPORT"
                ),
            ]
