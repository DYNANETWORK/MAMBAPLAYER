...
from driver.sukhi import call_py
        ...
        [
            [
                InlineKeyboardButton(
                    text="ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/MAMBA_X_SUPPORT"
                ),
                InlineKeyboardButton(
                    text="ʙᴏᴛ ᴄʜᴀᴀɴɴᴇʟ", url=f"https://t.me/MAMBA_X_SUPPORT"
                ),
            ]
        ]
    )
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/MAMBA_X_SUPPORT"
                ),
            ]
        ]
    )
